...
import {
  useTheme, Grid, Typography, Box, useMediaQuery,
} from '@mui/material';
import './About.css';
        ...
        >
          <Box mb={4}>
            <Typography variant="body1">
              Hola mi nombre es Nicolás Gravertt.
              Busco contribuir con mi experiencia en prácticas y
              habilidad en el logro de las metas generales de la empresa
              tanto como las responsabilidades a mi cargo,
              con la oportunidad de continuar desarrollándome.
            </Typography>
          </Box>
          <Skills />
        </Grid>
